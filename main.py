...
listBox = tk.Listbox(canvas, fg = "cyan", bg = "black", width = 100, font =('Scratches',14))
listBox.pack(padx = 15, pady = 15)

label = tk.Label(canvas, text = '', bg = 'black', fg = 'yellow', font = ('Scratches', 18))
label.pack(pady = 15)
