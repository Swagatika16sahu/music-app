...
print("""
                               ================================
                                      Welcome to Govt. Hospital
                               ================================
""")
##Establishing connection and creating database along with required tables
import mysql . connector as ms
cn=ms.connect(host="localhost",user="root",passwd="shuvaz@12345")
cur=cn.cursor()
...
def sign_up():
    print("""                   !!!!!!!Please enter new user details!!!!!!!!                     """)
    ...
    cn.commit()
    print("""                !!!!!!!!Congratulations!!!, New User Created...!!!!!!!!                    """)

def login():
    
    #Login with username and password

            print("''''           !!!!!!!!  {{Loginwith username and password }}  !!!!!!!!!!                """)
            un=input("Username!!:")
            ps=input("Password!!:")
            pid=0
                        ...
                        if a==1:
                            ...
                            #Menu for delete data
                               ...
                               #deleting worker details
                                ...
                                print("""
        ========================================================
        !!!!!!!!THANK YOU FOR USING THE Govt.HOSPITAL APP!!!!!!!!
        ========================================================
                                            """)
                                break
